...
* __charmap*__: Файл с мэппингом кодировки. Должен состоять из 256 символов UTF-8, где номер символа &ndash; его код в исходном компьютере.
...
Мэппер основного адресного пространства процессора.
...
* Мэппинг адресов памяти. Поиск подходящего условия происходи сверху вниз, поэтому первые строки имеют приоритет. Примеры записей:
