...
Модификаторы используются, когда состояние Shift на эмулируемом компьютере не совпадает с нужным для ввода символа на хосте. Например, при вводе &laquo;:&raquo; Shift нажимается, но на эмулируемой машине этот исмвол вводится без Shift &ndash; тогда в раскладке на нужной позиции будет &laquo;:_&raquo;, т.е. эта позиция в матрице соответствует двоеточию, но Shift нужно отпустить.
