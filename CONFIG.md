...
* Кодирование _bk_ повторяет сигнал Монитора БК и поддерживает как чтение, так и запись: остановка записи предлагает сохранить снятое как файл с заголовком адреса загрузки.
