...
Интерфейсы:
* __~scan__: Линии сканирования.
* __~output__: Выходные линии.
* __~shift__: Линия Shift;
* __~ctrl__: Линия Control;
* __~ruslat__: Линия Рус-Лат;
...
Параметры:
* __map*__: Файл маппинга клавиш. Должен находиться в каталоге с cfg.
