...
Раскладка задается с помощью файла, который представляет собой таблицу соответствия клавиш. Каждая строка соответствует линии сканирования. Каждый столбец &ndash; выходной линии.
