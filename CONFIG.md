...
* [Устройства](#Устройства)
    ...
    * Периферия
        ...
        * fdd (Дисковод)
        * i8255 (Порт ввода вывода i8255, КР580ВВ55)
        * i8257 (Контроллер ПДП i8257, КР580ВТ57)
        * i8275 (Видеоконтроллер i8275, КР580ВГ75)
        * i8253 (Таймер i8253, КР580ВИ53)
        * wd1793 (Контроллер дисковода WD1793, КР1818ВГ93)
    * Машино-зависимые устройства
        * orion-128-display (Дисплей Орион-128)
        * i8275-display (Дисплей на i8275)
