...
- [~] Улучшения кода.
- [~] Агат-7: исправлена цветовая палитра [#22](../../issues/22), конфигурация изменена на стандартную заводскую с 96 Кб памяти [#20](../../issues/20), исправлена ошибка с установкой видеорежима [#23](../../issues/23).
