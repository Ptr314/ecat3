...
void I8255Window::update()
{
    ...
    ui->hexA->setText(QString("%1").arg(va, 2, 16, QChar('0')));
    ui->binB->setText(QString("%1").arg(vb, 8, 2, QChar('0')));
    ui->hexB->setText(QString("%1").arg(vb, 2, 16, QChar('0')));
    ui->binCH->setText(QString("%1").arg(vc >> 4, 4, 2, QChar('0')));
    ui->binCL->setText(QString("%1").arg(vc & 0x0F, 4, 2, QChar('0')));
    ui->hexC->setText(QString("%1").arg(vc, 2, 16, QChar('0')));
    ui->binD->setText(QString("%1").arg(vd, 8, 2, QChar('0')));
    ui->hexD->setText(QString("%1").arg(vd, 2, 16, QChar('0')));

    ui->modeA->setText(((vd &  0x10) != 0)?"Input":"Output");
    ui->modeB->setText(((vd &  0x02) != 0)?"Input":"Output");
    ui->modeCH->setText(((vd & 0x08) != 0)?"Input":"Output");
    ui->modeCL->setText(((vd & 0x01) != 0)?"Input":"Output");
